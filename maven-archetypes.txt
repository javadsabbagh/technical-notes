...
35: remote -> com.agilejava.docbkx:docbkx-quickstart-archetype (-)
...
73: remote -> com.consol.citrus.mvn:citrus-quickstart (Citrus quickstart project)
...
106: remote -> com.github.blakepettersson:reactmann-java-archetype (A default archetype to create Reactmann verticles with.)
...
143: remote -> com.github.mkolisnyk:aerial-cucumber-testng-archetype (-)
...
186: remote -> com.handcraftedbits.archetype:handcraftedbits-archetype-simple (A Maven Archetype for Simple HandcraftedBits Projects)
...
220: remote -> com.liferay.maven.archetypes:liferay-portlet-spring-mvc-archetype (Provides an archetype to create Liferay Spring MVC portlets.)
...
259: remote -> com.sap.cloud.yaas.service-sdk:service-sdk-jersey-spring-archetype (hybris maven archetype for a basic YaaS Service)
...
300: remote -> com.thoughtworks.gauge.maven:gauge-archetype-selenium (Archetype for Gauge Java with Selenium)
...
327: remote -> com.wandrell.archetype:library (A Maven archetype to ease the creation of new libraries.)
...
362: remote -> de.cubeisland.maven.archetypes:archetype-cubeengine-module (This archetype generates a new module for the Cube Engine.)
...
395: remote -> edu.uchicago.mpcs53013:thrift-example-archetype (Creates an example program that serializes thrift logins)
...
419: remote -> info.kwarc.sally4.comm:comm-archetype (Semantic Alliance Communication Module Archetype)
...
454: remote -> io.fabric8.archetypes:eip-archetype (Creates a new quickstart project for Camel based Enterprise Integration Patterns.)
...
487: remote -> io.fabric8.archetypes:karaf-camel-webservice-archetype (Creates a new Camel example exposing a webservice to add or get Customers (backend is mocked in a bean))
...
522: remote -> io.fabric8.archetypes:war-cxf-cdi-servlet-archetype (Creates a new CXF JAX-RS using CDI deployed as WAR)
...
562: remote -> net.automatalib.archetypes:complete (-)
...
597: remote -> net.liftweb:lift-archetype-blank_2.10 (Blank project archetype for Lift Web Framework.)
...
630: remote -> net.osgiliath.archetypes:net.osgiliath.archetype.business.blueprint (Must be behind an Osgiliath parent archetype, business processing of data)
...
664: remote -> net.thucydides:thucydides-easyb-archetype (Thucydides automated acceptance testing project using Selenium 2, JUnit and easyb)
...
700: remote -> org.apache.axis2.archetype:quickstart (Maven archetype for creating a  Axis2 web Service)
...
736: remote -> org.apache.cxf.archetype:cxf-jaxrs-service (Simple CXF JAX-RS webapp service using Spring configuration)
...
776: remote -> org.apache.maven.archetypes:maven-archetype-site-simple (An archetype which contains a sample Maven site.)
...
813: remote -> org.apache.servicemix.tooling:servicemix-binding-component (-)
...
865: remote -> org.apache.sling:sling-bundle-archetype (Maven archetype for a generic OSGi bundle.)
866: remote -> org.apache.sling:sling-initial-content-archetype (Maven archetype for initial content)
867: remote -> org.apache.sling:sling-jcrinstall-bundle-archetype (Maven archetype for a generic OSGi bundle installed via JCR Install.)
868: remote -> org.apache.sling:sling-launchpad-standalone-archetype (Maven archetype for Sling Launchpad Standalone applications)
869: remote -> org.apache.sling:sling-launchpad-webapp-archetype (Maven archetype for Sling Launchpad Webapp applications)
870: remote -> org.apache.sling:sling-servlet-archetype (Maven archetype for Sling Servlets)
871: remote -> org.apache.sling:sling-slingstart-archetype (Maven archetype for a Sling Slingstart application)
872: remote -> org.apache.stanbol:enhancer-engine-archetype (-)
873: remote -> org.apache.stanbol:statefull-webmodule-archetype (Archetype for a project that accesses the entityhub, and logs queries to a persisten graph)
874: remote -> org.apache.stanbol:stateless-webmodule-archetype (Archetype for a project that allows posting files and shows the computed enhancements.)
875: remote -> org.apache.struts:struts2-archetype-angularjs (-)
876: remote -> org.apache.struts:struts2-archetype-blank (-)
877: remote -> org.apache.struts:struts2-archetype-convention (-)
878: remote -> org.apache.struts:struts2-archetype-dbportlet (-)
879: remote -> org.apache.struts:struts2-archetype-plugin (-)
880: remote -> org.apache.struts:struts2-archetype-portlet (-)
881: remote -> org.apache.struts:struts2-archetype-starter (-)
882: remote -> org.apache.synapse:synapse-package-archetype (This archetype can be used to create Maven projects that bundle a mediation
        into a standalone distribution ready to be executed)
883: remote -> org.apache.syncope:syncope-archetype (Apache Syncope Archetype)
884: remote -> org.apache.tapestry:quickstart (-)
885: remote -> org.apache.tapestry:tapestry-archetype (-)
886: remote -> org.apache.tapestry:tapestry-simple (Archetype for creating a basic Tapestry 5 application, including Eclipse control files.)
887: remote -> org.apache.tinkerpop:gremlin-archetype-server (-)
888: remote -> org.apache.tinkerpop:gremlin-archetype-tinkergraph (-)
889: remote -> org.apache.tomcat.maven:tomcat-maven-archetype (-)
890: remote -> org.apache.tomee.maven:tomee-webapp-archetype (-)
891: remote -> org.apache.turbine:turbine-webapp-2.3.3 (This archetype sets up a web application project based on Apache Turbine 2.3.3)
892: remote -> org.apache.turbine:turbine-webapp-4.0 (This archetype sets up a web application project based on Apache Turbine 4.0M1)
893: remote -> org.apache.tuscany.sca:tuscany-binding-archetype (Create a Tuscany binding extension project)
894: remote -> org.apache.tuscany.sca:tuscany-contribution-jar (Create an SCA JAR contribution project)
895: remote -> org.apache.tuscany.sca:tuscany-contribution-zip (Create an SCA ZIP contribution project)
896: remote -> org.apache.tuscany.sca:tuscany-policy-archetype (Create a Tuscany policy extension project)
897: remote -> org.apache.tuscany.sca:tuscany-quickstart (Create a simple Apache Tuscany SCA webapp project)
898: remote -> org.apache.tuscany.sca:tuscany-quickstart-bpel (Create an SCA Webapp project using BPEL)
899: remote -> org.apache.tuscany.sca:tuscany-quickstart-jsf (Create a Tuscany SCA and JSF project)
900: remote -> org.apache.tuscany.sca:tuscany-quickstart-jsonp (-)
901: remote -> org.apache.tuscany.sca:tuscany-quickstart-stripes (Create a simple Apache Tuscany SCA webapp project using the Stripes Web Framework)
902: remote -> org.apache.wicket:wicket-archetype-quickstart (-)
903: remote -> org.aperteworkflow:custom-widget-archetype (Aperte Workflow is a compilation of well-known, stable and mature frameworks into a
...
904: remote -> org.apidesign.bck2brwsr:bck2brwsr-archetype-html-sample (Creates a skeletal HTML page and associated Java controller class.
      Runs in any browser (even without Java plugin) with the help of Bck2Brwsr
      virtual machine.)
905: remote -> org.apidesign.bck2brwsr:knockout4j-archetype (HTML page with Knockout.js bindings driven by application model
      written in Java. Use your favorite language to code. Use
      HTML as a lightweight rendering toolkit. Deploy using JavaFX or 
      bck2brwsr virtual machine.)
906: remote -> org.apidesign.bck2brwsr:mojo (-)
907: remote -> org.apidesign.canvas:canvas-archetype (-)
908: remote -> org.apidesign.html:crud4j-archetype (HTML page with master/detail showing results obtains
      for a Jersey server. Everything written in Java. 
      Use your favorite language to code. Run the same code 
      on server as well as client. Use
      HTML as a lightweight rendering toolkit. Deploy to desktop,
      Android, iOS, HTML5 browser.)
909: remote -> org.apidesign.html:knockout4j-archetype (HTML page with Knockout.js bindings driven by application model
      written in Java. Use your favorite language to code. Use
      HTML as a lightweight rendering toolkit. Deploy to desktop,
      Android, iOS, HTML5 browser.)
910: remote -> org.appfuse:appfuse-basic-jsf (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
911: remote -> org.appfuse:appfuse-basic-spring (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
912: remote -> org.appfuse:appfuse-basic-struts (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
913: remote -> org.appfuse:appfuse-basic-tapestry (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
914: remote -> org.appfuse:appfuse-core (Maven 2 archetype that creates a backend (Managers, DAOs and Web Services)
        application with AppFuse embedded in it.)
915: remote -> org.appfuse:appfuse-modular-jsf (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
...
916: remote -> org.appfuse:appfuse-modular-spring (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Spring MVC implementation.)
917: remote -> org.appfuse:appfuse-modular-struts (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Struts implementation.)
918: remote -> org.appfuse:appfuse-modular-tapestry (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Tapestry implementation.)
919: remote -> org.appfuse.archetypes:appfuse-basic-gwt-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
920: remote -> org.appfuse.archetypes:appfuse-basic-jsf (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
921: remote -> org.appfuse.archetypes:appfuse-basic-jsf-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
922: remote -> org.appfuse.archetypes:appfuse-basic-spring (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
923: remote -> org.appfuse.archetypes:appfuse-basic-spring-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
924: remote -> org.appfuse.archetypes:appfuse-basic-struts (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
925: remote -> org.appfuse.archetypes:appfuse-basic-struts-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
926: remote -> org.appfuse.archetypes:appfuse-basic-tapestry (Maven 2 archetype that creates a web application with AppFuse embedded in it.)
927: remote -> org.appfuse.archetypes:appfuse-basic-tapestry-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
928: remote -> org.appfuse.archetypes:appfuse-basic-wicket-archetype (AppFuse Web Frameworks: JSF, Spring MVC, Struts 2 and Tapestry.)
929: remote -> org.appfuse.archetypes:appfuse-core (Maven 2 archetype that creates a backend (Managers, DAOs and Web Services)
        application with AppFuse embedded in it.)
930: remote -> org.appfuse.archetypes:appfuse-core-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
931: remote -> org.appfuse.archetypes:appfuse-light-jsf-archetype (AppFuse Archetype)
932: remote -> org.appfuse.archetypes:appfuse-light-spring-archetype (AppFuse Archetype)
933: remote -> org.appfuse.archetypes:appfuse-light-spring-freemarker-archetype (AppFuse Archetype)
934: remote -> org.appfuse.archetypes:appfuse-light-spring-security-archetype (AppFuse Archetype)
935: remote -> org.appfuse.archetypes:appfuse-light-stripes-archetype (AppFuse Archetype)
936: remote -> org.appfuse.archetypes:appfuse-light-struts-archetype (AppFuse Archetype)
937: remote -> org.appfuse.archetypes:appfuse-light-tapestry-archetype (AppFuse Archetype)
938: remote -> org.appfuse.archetypes:appfuse-light-wicket-archetype (AppFuse Archetype)
939: remote -> org.appfuse.archetypes:appfuse-modular-gwt-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
940: remote -> org.appfuse.archetypes:appfuse-modular-jsf (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's JSF implementation.)
941: remote -> org.appfuse.archetypes:appfuse-modular-jsf-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
942: remote -> org.appfuse.archetypes:appfuse-modular-spring (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Spring MVC implementation.)
943: remote -> org.appfuse.archetypes:appfuse-modular-spring-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
944: remote -> org.appfuse.archetypes:appfuse-modular-struts (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Struts implementation.)
945: remote -> org.appfuse.archetypes:appfuse-modular-struts-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
946: remote -> org.appfuse.archetypes:appfuse-modular-tapestry (Maven 2 archetype that creates a modular web application with AppFuse. This archetype creates two modules:
        "core" and "web". The core module depends on appfuse-service, while the web module depends on core as well
        as AppFuse's Tapestry implementation.)
947: remote -> org.appfuse.archetypes:appfuse-modular-tapestry-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
948: remote -> org.appfuse.archetypes:appfuse-modular-wicket-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
949: remote -> org.appfuse.archetypes:appfuse-ws-archetype (AppFuse is a full-stack framework for building web applications on the JVM.)
950: remote -> org.appverse.web.framework.archetypes.gwt:appverse-web-archetypes-gwt (Appverse Web Framework Archetypes GWT Archetype)
951: remote -> org.appverse.web.framework.archetypes.gwt:appverse-web-archetypes-gwt-eclipselink (Appverse Web Framework Archetypes GWT Eclipselink Archetype)
952: remote -> org.appverse.web.framework.archetypes.gwt:appverse-web-archetypes-gwt-hibernate (Appverse Web Framework Archetypes GWT Hibernate Archetype)
953: remote -> org.appverse.web.framework.archetypes.gwtproject:appverse-web-archetypes-gwtproject (Appverse Web Framework Tools Archetypes GWT Project)
954: remote -> org.appverse.web.framework.archetypes.jsf2:appverse-web-archetypes-jsf2 (Appverse Web Framework Archetypes JSF2 Archetype)
955: remote -> org.appverse.web.framework.archetypes.rest:appverse-web-archetypes-rest-eclipselink (Appverse Web Framework Archetypes Rest Eclipselink Archetype)
956: remote -> org.appverse.web.framework.tools.archetypes.gwtproject:appverse-web-tools-archetypes-gwtproject (Appverse Web Framework Tools Archetypes GWT Project)
957: remote -> org.atteo.moonshine:distribution-archetype (-)
958: remote -> org.atteo.moonshine:hibernate-archetype (-)
959: remote -> org.atteo.moonshine:rest-archetype (-)
960: remote -> org.atteo.moonshine:service-archetype (-)
961: remote -> org.atteo.moonshine:standalone-archetype (-)
962: remote -> org.avaje.ebeanorm:ebean-start (-)
963: remote -> org.baracus.application:baracus-maven-archetype (Maven Mrchetype for the BARACUS framework for Android application)
964: remote -> org.beamfoundry.bundles.spring-dm:org.beamfoundry.bundles.spring-dm-bundle-archetype (Spring DM Maven2 Archetype)
965: remote -> org.beangle.webmvc:beangle-webmvc-archetype-starter (-)
966: remote -> org.beangle.webui:beangle-webui-archetype_2.11 (-)
967: remote -> org.beangle.webui:beangle-webui-archetype_2.12 (-)
968: remote -> org.biopax.paxtools:paxtools-archetype (Paxtools Maven archetype - sample Java project to quickly start using Paxtools library and BioPAX data.)
969: remote -> org.bitbucket.bradleysmithllc.etlunit:etlunit-database-schema-archetype (-)
970: remote -> org.bitbucket.bradleysmithllc.etlunit:etlunit-feature-archetype (-)
971: remote -> org.bitbucket.bradleysmithllc.etlunit:etlunit-project-archetype (-)
972: remote -> org.bitbucket.bradleysmithllc.etlunit:feature-archetype (-)
973: remote -> org.bitbucket.bradleysmithllc.etlunit:project-archetype (-)
974: remote -> org.blueoxygen.cimande:cimande-archetype (-)
975: remote -> org.blueoxygen.cimande:cimande-archetype-blank (-)
976: remote -> org.boretti.drools.integration:drools4-integration-helper-archetype (Support of the archetype for the Maven plugin)
977: remote -> org.boretti.drools.integration:drools5-integration-helper-archetype (This is an Maven 2 Archetype to support creation of a ready to
...
978: remote -> org.brillien:brillien-archetype (-)
979: remote -> org.broadleafcommerce:ecommerce-archetype (BroadleafCommerce ECommerce Archetype)
980: remote -> org.brutusin:jsonsrv-archetype (Maven archetype for creation of jsonsrv projects)
981: remote -> org.brutusin:rpc-tomcat-jar (Maven archetype for creation of Brutusin-RPC jar (standalone) projects, with a Tomcat runtime embedded)
982: remote -> org.brutusin:rpc-tomcat-war (Maven archetype for creation of Brutusin-RPC (standalone and deployable) war projects with a Tomcat runtime available for standalone scenarios)
983: remote -> org.camunda.bpm.archetype:camunda-archetype-cockpit-plugin (Plugin for Camunda Cockpit, contains REST-Backend, MyBatis database query, HTML and JavaScript frontend, Ant build script for one-click deployment)
984: remote -> org.camunda.bpm.archetype:camunda-archetype-ejb-war (Process application that uses a shared Camunda BPM engine in a Java EE Container, e.g. JBoss AS7.
...
985: remote -> org.camunda.bpm.archetype:camunda-archetype-servlet-war (Process application that uses a shared Camunda BPM engine in a Servlet Container, e.g. Apache Tomcat.
...
986: remote -> org.carewebframework:org.carewebframework.mvn.archetype.plugin (-)
987: remote -> org.chtijbug.drools:drools-service-runner-archetype (-)
988: remote -> org.codehaus.cargo:cargo-archetype-daemon (Sample Maven archetype showing how to configure Cargo and Maven to generate a webapp and remotely start and stop a container with the application deployed on it.)
989: remote -> org.codehaus.cargo:cargo-archetype-multiple-containers (Sample Maven archetype showing how to start / stop multiple containers.)
990: remote -> org.codehaus.cargo:cargo-archetype-remote-deployment (Sample Maven archetype showing how to configure Cargo and Maven to generate a webapp and deploy it to a remote container.)
991: remote -> org.codehaus.cargo:cargo-archetype-webapp-functional-tests-module (Sample Maven archetype showing how to configure Cargo and Maven to run functional tests for a webapp by creating a separate functional-tests module.)
992: remote -> org.codehaus.cargo:cargo-archetype-webapp-single-module (Sample Maven archetype showing how to configure Cargo and Maven to run functional tests directly from a single webapp module.)
993: remote -> org.codehaus.cargo:cargo-archetype-webapp-with-datasource (Sample Maven archetype showing how to configure Cargo and Maven to run functional tests directly from a webapp with datasource. Cargo will be used to configure the datasource on the container.)
994: remote -> org.codehaus.castor:castor-archetype-codegen-testcase (Maven archetype of a JUnit test case for the Castor XML code generator)
995: remote -> org.codehaus.castor:codegen-testcase (-)
996: remote -> org.codehaus.castor:cpa-testcase (-)
997: remote -> org.codehaus.enunciate.archetypes:enunciate-simple-archetype (-)
998: remote -> org.codehaus.gmaven.archetypes:gmaven-archetype-basic (-)
999: remote -> org.codehaus.gmaven.archetypes:gmaven-archetype-mojo (-)
1000: remote -> org.codehaus.groovy.maven.archetypes:gmaven-archetype-basic (-)
1001: remote -> org.codehaus.groovy.maven.archetypes:gmaven-archetype-mojo (-)
1002: remote -> org.codehaus.mevenide.plugins:maven-archetype-nbm (Archetype for Netbeans Modules Maven setup)
1003: remote -> org.codehaus.mojo:gwt-maven-plugin (Mojo's Maven Plugin for GWT)
1004: remote -> org.codehaus.mojo:javascript-ria-archetype (A JavaScript Rich Internet Application template using jQuery and jQuery UI.)
1005: remote -> org.codehaus.mojo:latex-maven-archetype (The LaTeX Maven Archetype is kickstarts your LaTeX / Maven projects.)
1006: remote -> org.codehaus.mojo:xmlbeans-maven-plugin (Runs the xmlbeans parser/code generator against schemas in files and dependent jars.)
1007: remote -> org.codehaus.mojo.archetypes:appclient-javaee6 (Archetype for an Application Client package using Java EE 6.)
1008: remote -> org.codehaus.mojo.archetypes:appclient-javaee7 (Archetype for an Application Client package using Java EE 7.)
1009: remote -> org.codehaus.mojo.archetypes:appclient-jee5 (Archetype for an Application Client package using Java EE 5.)
1010: remote -> org.codehaus.mojo.archetypes:appframework (Archetype for creating application based on JSR 296)
1011: remote -> org.codehaus.mojo.archetypes:ear-j2ee14 (Archetype for creating J2EE 1.4 EAR)
1012: remote -> org.codehaus.mojo.archetypes:ear-javaee6 (Archetype for EAR package using Java EE 6)
1013: remote -> org.codehaus.mojo.archetypes:ear-javaee7 (Archetype for EAR package using Java EE 7)
1014: remote -> org.codehaus.mojo.archetypes:ear-jee5 (Archetype for creating JEE 5 EAR)
1015: remote -> org.codehaus.mojo.archetypes:ejb-j2ee13 (An archetype which contains a sample J2EE 1.3 EJB Maven project.)
1016: remote -> org.codehaus.mojo.archetypes:ejb-j2ee14 (An archetype which contains a sample J2EE 1.4 EJB Maven project.)
1017: remote -> org.codehaus.mojo.archetypes:ejb-javaee6 (Archetype for an EJB package using Java EE 6.)
1018: remote -> org.codehaus.mojo.archetypes:ejb-javaee7 (Archetype for an EJB package using Java EE 7.)
1019: remote -> org.codehaus.mojo.archetypes:ejb-jee5 (JEE 5 ejb jar archetype)
1020: remote -> org.codehaus.mojo.archetypes:javafx (Archetype for creating a JavaFX application)
1021: remote -> org.codehaus.mojo.archetypes:nbm-archetype (Archetype for development of NetBeans modules in Maven.)
1022: remote -> org.codehaus.mojo.archetypes:nbm-osgi-archetype (Archetype for development of NetBeans modules that can depend on OSGi bundles.)
1023: remote -> org.codehaus.mojo.archetypes:nbm-suite-root (Root project archetype for creating multi module projects developing NetBeans IDE modules. Approximately similar in functionality to module suites in NetBeans Ant projects.)
1024: remote -> org.codehaus.mojo.archetypes:netbeans-platform-app-archetype (Archetype for sample application based on NetBeans Platform. Creates parent POM with branding and empty NBM project.)
1025: remote -> org.codehaus.mojo.archetypes:osgi-archetype (Archetype for development of OSGi bundles using Apache Felix Maven plugin)
1026: remote -> org.codehaus.mojo.archetypes:pom-root (Root project archetype for creating multi module projects)
1027: remote -> org.codehaus.mojo.archetypes:sample-javafx (Sample archetype for creating a JavaFX application)
1028: remote -> org.codehaus.mojo.archetypes:webapp-j2ee13 (J2EE 1.3 web application archetype)
1029: remote -> org.codehaus.mojo.archetypes:webapp-j2ee14 (J2EE 1.4 web application archetype)
1030: remote -> org.codehaus.mojo.archetypes:webapp-javaee6 (Archetype for a web application using Java EE 6.)
1031: remote -> org.codehaus.mojo.archetypes:webapp-javaee7 (Archetype for a web application using Java EE 7.)
1032: remote -> org.codehaus.mojo.archetypes:webapp-jee5 (JEE 5 web application archetype)
1033: remote -> org.codehaus.mojo.groovy:groovy-maven-archetype (An archetype for creating Maven modules/projects using the Groovy language.)
1034: remote -> org.codehaus.mojo.groovy:groovy-mojo-archetype (An archetype for writing Maven 2 plugins in the Groovy language.)
1035: remote -> org.codehaus.openxma:org.openxma.dsl.sample-archetype (-)
1036: remote -> org.codehaus.sonar.archetypes:sonar-basic-plugin-archetype (Maven archetype to create a basic Sonar plugin)
1037: remote -> org.codehaus.sonar.archetypes:sonar-gwt-plugin-archetype (Maven archetype to create a Sonar plugin including GWT pages)
1038: remote -> org.codelibs:elasticsearch-plugin-archetype (This archetype generates your project for Elasticsearch plugin.)
1039: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty6 (-)
1040: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty7 (-)
1041: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty8 (-)
1042: remote -> org.cometd.archetypes:cometd-archetype-dojo-jetty9 (-)
1043: remote -> org.cometd.archetypes:cometd-archetype-jquery-jetty6 (-)
1044: remote -> org.cometd.archetypes:cometd-archetype-jquery-jetty7 (-)
1045: remote -> org.cometd.archetypes:cometd-archetype-jquery-jetty8 (-)
1046: remote -> org.cometd.archetypes:cometd-archetype-jquery-jetty9 (-)
1047: remote -> org.cometd.archetypes:cometd-archetype-spring-dojo-jetty7 (-)
1048: remote -> org.cometd.archetypes:cometd-archetype-spring-dojo-jetty9 (-)
1049: remote -> org.cometd.archetypes:cometd-archetype-spring-jquery-jetty7 (-)
1050: remote -> org.cometd.archetypes:cometd-archetype-spring-jquery-jetty9 (-)
1051: remote -> org.conventionsframework:conventions-archetype (-)
1052: remote -> org.coosproject.maven.archetypes:coos-plugin-actor (-)
1053: remote -> org.coosproject.maven.archetypes:coos-plugin-api (-)
1054: remote -> org.coosproject.maven.archetypes:coos-plugin-noapi (-)
1055: remote -> org.cruxframework:crux-helloworld-war (HelloWorld Crux war application.)
1056: remote -> org.cruxframework:crux-module-app (Crux application following the module layout for project.)
1057: remote -> org.cruxframework:crux-module-app-archetype (This is the Crux Module App Archetype)
1058: remote -> org.cruxframework:crux-module-app-container-archetype (This is the Crux Module Container App Archetype)
1059: remote -> org.cruxframework:crux-module-container-app (Crux application following the module container layout for project.)
1060: remote -> org.cruxframework:crux-project-jar (Blank Crux jar application.)
1061: remote -> org.cruxframework:crux-project-war (Blank Crux war application.)
1062: remote -> org.dd4t:dd4t-spring-mvc-archetype (DD4T Spring MVC Archetype for Maven)
1063: remote -> org.debux.webmotion:webmotion-archetype (WebMotion is Java web framework based on the Java EE6 standard)
1064: remote -> org.devnull:devnull-web-archetype (DevNull starter webaapp with Spring MVC, JPA, Groovy and Twitter Bootstrap)
1065: remote -> org.devoxx4kids.bukkit.plugins:bukkit-template (Bukkit Template Plugin)
1066: remote -> org.devoxx4kids.spigot.plugins:spigot-template (Spigot Template Plugin)
1067: remote -> org.dishevelled:dsh-archetype (dishevelled.org maven project archetype.)
1068: remote -> org.drombler.fx:drombler-fx-maven-archetype-application (A sample Drombler FX application template.)
1069: remote -> org.duelengine:duel-mvc-archetype (MVC project archetype using Jersey, Guice, DUEL views, DUEL merge)
1070: remote -> org.duelengine:war-bootstrap-archetype (Simple WAR bootstrap for quick & dirty testing in multiple servlet containers (Tomcat, Jetty, Glassfish).)
1071: remote -> org.easybatch:easybatch-archetype (Easy Batch maven quick start archetype)
1072: remote -> org.easyrules:easyrules-archetype (Maven archetype to create a skeleton project)
1073: remote -> org.eclipse.hudson.tools:maven-hpi-plugin (Support for developing Hudson plugins with Apache Maven.)
1074: remote -> org.eclipse.scout.archetypes:scout-helloworld-app (Maven Archetype which creates a Scout Hello World Sample Application)
1075: remote -> org.eclipse.xtend:xtend-android-archetype (-)
1076: remote -> org.eclipse.xtend:xtend-archetype (-)
1077: remote -> org.eclipselabs:emf-gwt-jersey (-)
1078: remote -> org.eclipselabs:emf-gwt-rpc (-)
1079: remote -> org.eiichiro.gig:gig-archetype-appengine (An archetype which contains a simple Gig Webapp project for Google App Engine.)
1080: remote -> org.eiichiro.gig:gig-archetype-heroku (An archetype which contains a simple Gig Webapp project for Heroku.)
1081: remote -> org.eiichiro.gig:gig-archetype-webapp (An archetype which contains a simple Gig Webapp project.)
1082: remote -> org.entando.entando:entando-archetype-bundle-content (Content Type Bundle Archetype for Entando.)
1083: remote -> org.entando.entando:entando-archetype-bundle-misc (Generic Misc Bundle Archetype for Entando.)
1084: remote -> org.entando.entando:entando-archetype-bundle-page-generic (Generic Page Bundle Archetype for Entando.)
1085: remote -> org.entando.entando:entando-archetype-bundle-showlet-generic (Generic Showlet Bundle Archetype for Entando.)
1086: remote -> org.entando.entando:entando-archetype-bundle-theme-generic (Theme (Page Model) Bundle Archetype for Entando.)
1087: remote -> org.entando.entando:entando-archetype-bundle-widget-generic (Widget Bundle Archetype for Entando.)
1088: remote -> org.entando.entando:entando-archetype-plugin-generic (Plugin Archetype for Entando:  an agile, modern and user-centric open source portal-like platform.)
1089: remote -> org.entando.entando:entando-archetype-portal-bootstrap (Twitter Bootstrap Portal Archetype for Entando: an agile, modern and user-centric open source portal-like platform.)
1090: remote -> org.entando.entando:entando-archetype-portal-generic (Generic Portal Archetype for Entando: an agile, modern and user-centric open source portal-like platform.)
1091: remote -> org.fluttercode.knappsack:jee6-basic-archetype (Java EE 6 Knappsack archetype with configuration for CDI, JSF, JPA and a sample empty page.)
1092: remote -> org.fluttercode.knappsack:jee6-minimal-archetype (Java EE 6 Knappsack archetype with a single page demo of CDI, JSF, JPA and Validation to verify everything works.)
1093: remote -> org.fluttercode.knappsack:jee6-sandbox-archetype (Java EE 6 Knappsack archetype sandbox project for Java EE 6 with CDI, JSF, JPA and a sample model and test data to play around with, try new things, and use as a foundation for tutorials)
1094: remote -> org.fluttercode.knappsack:jee6-sandbox-demo-archetype (Java EE 6 Knappsack archetype containing a complete demo example using CDI, JSF, JPA and validation showcasing a number of features available in Java EE 6 as well as demonstrating how to make them all work together)
1095: remote -> org.fluttercode.knappsack:jee6-servlet-basic-archetype (Java EE 6 Knappsack archetype for servlet containers (Jetty,Tomcat) with just a single page and a persistence provider .)
1096: remote -> org.fluttercode.knappsack:jee6-servlet-demo-archetype (Java EE 6 Knappsack archetype containing servlet based bookmarking application demonstrating JSF, CDI, JPA and Bean Validation on Tomcat/Jetty servlet containers)
1097: remote -> org.fluttercode.knappsack:jee6-servlet-minimal-archetype (Java EE 6 Knappsack archetype containing a minimal Java EE application for servlet containers (Jetty,Tomcat) with a single page demo of CDI, JSF, JPA and Validation to verify everything works.)
1098: remote -> org.fluttercode.knappsack:jee6-servlet-sandbox-archetype (Java EE 6 Knappsack archetype for servlet containers (Jetty,Tomcat) with sandbox data built in.)
1099: remote -> org.fluttercode.knappsack:spring-jsf-jpa-archetype (Spring Knappsack archetype application with setup for JPA and JSF)
1100: remote -> org.fluttercode.knappsack:spring-mvc-jpa-archetype (Spring MVC Knappsack archetype application with setup for JPA)
1101: remote -> org.fluttercode.knappsack:spring-mvc-jpa-demo-archetype (Spring MVC Knappsack demo archetype application with JPA)
1102: remote -> org.fuin.archetypes:emt-xtext-archetype (Maven archetype that creates an Xtext project with a multi module Maven layout and Tycho (manifest-first approach).)
1103: remote -> org.fusesource.fabric:camel-cxf-code-first-archetype (Creates a new Camel project using CXF in code (Java) first.)
1104: remote -> org.fusesource.fabric:camel-cxf-contract-first-archetype (Creates a new Camel project using CXF in contract (WSDL) first.)
1105: remote -> org.fusesource.fabric:camel-drools-archetype (Creates a new Camel project using the Drools rule engine.)
1106: remote -> org.fusesource.scalate.tooling:scalate-archetype-empty (An archetype which creates an empty Scalate web application)
1107: remote -> org.fusesource.scalate.tooling:scalate-archetype-guice (An archetype which creates an empty Scalate Guice web application)
1108: remote -> org.fusesource.scalate.tooling:scalate-archetype-guice_2.10 (An archetype which creates an empty Scalate Guice web application)
1109: remote -> org.fusesource.scalate.tooling:scalate-archetype-guice_2.9 (An archetype which creates an empty Scalate Guice web application)
1110: remote -> org.fusesource.scalate.tooling:scalate-archetype-jersey (An archetype which creates an empty Scalate web application)
1111: remote -> org.fusesource.scalate.tooling:scalate-archetype-jersey_2.10 (An archetype which creates an empty Scalate web application)
1112: remote -> org.fusesource.scalate.tooling:scalate-archetype-jersey_2.9 (An archetype which creates an empty Scalate web application)
1113: remote -> org.fusesource.scalate.tooling:scalate-archetype-sitegen (An archetype which creates an empty Scalate static website generation project)
1114: remote -> org.fusesource.scalate.tooling:scalate-archetype-sitegen_2.10 (An archetype which creates an empty Scalate static website generation project)
1115: remote -> org.fusesource.scalate.tooling:scalate-archetype-sitegen_2.9 (An archetype which creates an empty Scalate static website generation project)
1116: remote -> org.geomajas:geomajas-gwt-archetype (Geomajas GWT application archetype)
1117: remote -> org.geomajas:geomajas-plugin-archetype (Geomajas plugin archetype)
1118: remote -> org.geoserver.maven:geoserver-archetype-wfsoutputformat (-)
1119: remote -> org.glassfish.jersey.archetypes:jersey-example-java8-webapp (Jersey (Java8) WebApp Example Archetype.)
1120: remote -> org.glassfish.jersey.archetypes:jersey-heroku-webapp (An archetype which contains a quick start Jersey-based web application project capable to run on Heroku.)
1121: remote -> org.glassfish.jersey.archetypes:jersey-quickstart-grizzly2 (An archetype which contains a quick start Jersey project based on Grizzly container.)
1122: remote -> org.glassfish.jersey.archetypes:jersey-quickstart-webapp (An archetype which contains a quick start Jersey-based web application project.)
1123: remote -> org.glassfish.tyrus.archetypes:tyrus-archetype-echo (An archetype which contains a Tyrus echo application.)
1124: remote -> org.glassmaker:org.glassmaker.archetype.basic (-)
1125: remote -> org.grails:grails-maven-archetype (Maven archetype for Grails projects.)
1126: remote -> org.graniteds.archetypes:graniteds-flex-spring-jpa-hibernate (Base project with Flex 4.6, Spring 3 and Hibernate using GraniteDS with RemoteObject API.)
1127: remote -> org.graniteds.archetypes:graniteds-spring-jpa-hibernate (Base project with Flex 4.5, Spring 3 and Hibernate using GraniteDS with RemoteObject API.)
1128: remote -> org.graniteds.archetypes:graniteds-tide-cdi-jpa (Base project with Flex 4.5 and CDI using GraniteDS with the Tide API.)
1129: remote -> org.graniteds.archetypes:graniteds-tide-flex-cdi-jpa (Base project with Flex 4.6, CDI and JPA using GraniteDS with Tide API.)
1130: remote -> org.graniteds.archetypes:graniteds-tide-flex-seam-jpa-hibernate (Base project with Flex 4.6, JBoss Seam 2.2 and Hibernate using GraniteDS with the Tide API.)
1131: remote -> org.graniteds.archetypes:graniteds-tide-flex-spring-jpa-hibernate (Base project with Flex 4.6, Spring 3.1 and Hibernate 3.6 using GraniteDS with the Tide API.)
1132: remote -> org.graniteds.archetypes:graniteds-tide-javafx-spring-jpa-hibernate (Base project with JavaFX 2.2, Spring 3.1 and Hibernate 3.6 using GraniteDS with the Tide API.)
1133: remote -> org.graniteds.archetypes:graniteds-tide-seam-jpa-hibernate (Base project with Flex 4.5, JBoss Seam 2.2 and Hibernate using GraniteDS with the Tide API.)
1134: remote -> org.graniteds.archetypes:graniteds-tide-spring-jpa-hibernate (Base project with Flex 4.5, Spring 3 and Hibernate using GraniteDS with the Tide API.)
1135: remote -> org.graphwalker:graphwalker-maven-archetype (-)
1136: remote -> org.graylog:graylog-plugin-archetype (-)
1137: remote -> org.graylog2:graylog2-plugin-archetype (-)
1138: remote -> org.grouplens.lenskit:lenskit-archetype-fancy-analysis (-)
1139: remote -> org.grouplens.lenskit:lenskit-archetype-simple-analysis (-)
1140: remote -> org.hibernate:hibernate-search-quickstart (-)
1141: remote -> org.hibernate:hibernate-validator-quickstart-archetype (Aggregator of the Hibernate Validator modules.)
1142: remote -> org.ikasan:ikasan-build-parent-maven-plugin (-)
1143: remote -> org.ikasan:ikasan-im-jboss6-activemq-maven-plugin (-)
1144: remote -> org.ikasan:ikasan-im-jboss6-db-maven-plugin (-)
1145: remote -> org.ikasan:ikasan-im-jboss6-filesystem-maven-plugin (-)
1146: remote -> org.ikasan:ikasan-im-jboss6-jms-maven-plugin (-)
1147: remote -> org.ikasan:ikasan-im-jboss6-sftp-maven-plugin (-)
1148: remote -> org.ikasan:ikasan-integration-module-jboss6-maven-plugin (-)
1149: remote -> org.ikasan:ikasan-rt-conf-jboss6-maven-plugin (-)
1150: remote -> org.ikasan:jboss6-module-activemq-maven-plugin (-)
1151: remote -> org.imixs.application:imixs-workflow-jee-archetype (Imixs Workflow JEE Archetype provides a JEE Sample Application)
1152: remote -> org.integratedmodelling:klab-component-quickstart (Use this archetype to quickly populate a Maven project suitable for implementing a new k.LAB component.)
1153: remote -> org.irenical:maven-archetype-jar (For a standard LGPL Java library generation)
1154: remote -> org.irenical.maven:archetype-uservice (-)
1155: remote -> org.jacpfx:JacpFX-empty-quickstart (A simple JacpFX quistart application with two perspectives and four components.)
1156: remote -> org.jacpfx:JacpFX-simple-quickstart (JacpFX arechetype with predefined workbench, perspective and components. This is a good starting point to dive into JacpFX..)
1157: remote -> org.jasig.portlet.archetype:jsr286-archetype (-)
1158: remote -> org.javaee-samples:javaee7-arquillian-archetype (JavaEE 7 Arquillian Archetype Sample)
1159: remote -> org.jbehave:jbehave-groovy-archetype (An archetype to run multiple textual stories with steps classes written in Groovy.)
1160: remote -> org.jbehave:jbehave-guice-archetype (An archetype to run multiple textual stories configured programmatically but with steps classes composed using Guice.)
1161: remote -> org.jbehave:jbehave-needle-archetype (An archetype to run multiple textual stories configured programmatically but with steps classes composed using Needle.)
1162: remote -> org.jbehave:jbehave-pico-archetype (An archetype to run multiple textual stories configured programmatically but with steps classes composed using Pico.)
1163: remote -> org.jbehave:jbehave-simple-archetype (An archetype to run multiple textual stories configured programmatically.)
1164: remote -> org.jbehave:jbehave-spring-archetype (An archetype to run multiple textual stories configured programmatically but with steps classes composed using Spring.)
1165: remote -> org.jbehave.web:jbehave-web-selenium-flash-archetype (An archetype to run web Flash stories using Selenium.)
1166: remote -> org.jbehave.web:jbehave-web-selenium-groovy-pico-archetype (An archetype to run web stories using Selenium, Groovy and Pico.)
1167: remote -> org.jbehave.web:jbehave-web-selenium-java-spring-archetype (An archetype to run web stories using Selenium, Java and Spring.)
1168: remote -> org.jboss.aerogear.archetypes:jboss-html5-mobile-archetype (An archetype that generates a Java EE 6 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1169: remote -> org.jboss.aerogear.archetypes:jboss-html5-mobile-blank-archetype (An archetype that generates a Java EE 6 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1170: remote -> org.jboss.archetype.eap:jboss-javaee6-webapp-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss EAP 6)
1171: remote -> org.jboss.archetype.eap:jboss-javaee6-webapp-blank-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss EAP 6)
1172: remote -> org.jboss.archetype.eap:jboss-javaee6-webapp-ear-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss EAP 6. The project is an EAR, with an EJB-JAR and WAR)
1173: remote -> org.jboss.archetype.eap:jboss-javaee6-webapp-ear-blank-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss EAP 6. The project is an EAR, with an EJB-JAR and WAR)
1174: remote -> org.jboss.archetype.forge:jboss-forge-html5-archetype (An archetype that contains pre-requisites for demonstrating the use of JBoss Forge. The end-user will be instructed on how to scaffold a new application based on a pre-existing JPA entity. Refer to the embedded Eclipse cheatsheet for additional details.)
1175: remote -> org.jboss.archetype.wfk:jboss-html5-mobile-archetype (An archetype that generates a Java EE 6 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1176: remote -> org.jboss.archetype.wfk:jboss-html5-mobile-blank-archetype (An archetype that generates a Java EE 6 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1177: remote -> org.jboss.archetype.wfk:jboss-spring-mvc-archetype (An archetype that generates a starter Spring MVC application with Java EE persistence settings (server bootstrapped JPA, JTA transaction management) for JBoss AS7)
1178: remote -> org.jboss.archetype.wfk:richfaces-archetype-kitchensink (JBoss WFK Archetype: Based on the Kitchen Sink Quickstart but adds RichFaces)
1179: remote -> org.jboss.archetype.wfk:richfaces-archetype-simpleapp (JBoss WFK Archetype: RichFaces Archetypes Simple Application)
1180: remote -> org.jboss.as.archetypes:jboss-as-subsystem (An archetype that generates a skeleton project for implementing a JBoss AS 7 subsystem)
1181: remote -> org.jboss.errai.archetypes:bus-quickstart (-)
1182: remote -> org.jboss.errai.archetypes:cdi-quickstart (-)
1183: remote -> org.jboss.errai.archetypes:cordova-quickstart (-)
1184: remote -> org.jboss.errai.archetypes:jaxrs-quickstart (-)
1185: remote -> org.jboss.errai.archetypes:jboss-errai-kitchensink-archetype (A starter Errai + Java EE 6 webapp project for use on JBoss AS 7 / EAP 6, generated from the jboss-errai-kitchensink-archetype archetype)
1186: remote -> org.jboss.errai.archetypes:kitchensink-quickstart (A starter Errai + Java EE 6 webapp project for use on JBoss AS 7 / EAP 6, generated from the kitchensink-quickstart archetype)
1187: remote -> org.jboss.maven.archetypes:selenium-testng (-)
1188: remote -> org.jboss.portletbridge.archetypes:1.2-basic (-)
1189: remote -> org.jboss.portletbridge.archetypes:2.0-basic (-)
1190: remote -> org.jboss.portletbridge.archetypes:2.0-basic-archetype (-)
1191: remote -> org.jboss.portletbridge.archetypes:jsf2-basic-archetype (-)
1192: remote -> org.jboss.portletbridge.archetypes:richfaces-basic (-)
1193: remote -> org.jboss.portletbridge.archetypes:richfaces-simpleapp-archetype (-)
1194: remote -> org.jboss.portletbridge.archetypes:seam-basic (-)
1195: remote -> org.jboss.reddeer:jboss-reddeer-archetype (Red Deer Archetype)
1196: remote -> org.jboss.spec.archetypes:jboss-html5-mobile-archetype (An archetype that generates a Java EE 6 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1197: remote -> org.jboss.spec.archetypes:jboss-javaee6-ear-webapp (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7. The project is an EAR, with an EJB-JAR and WAR)
1198: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7)
1199: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7.1 (by default) or EAP 6 (if the "enterprise" property is true))
1200: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-archetype-blank (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7 (by default) or EAP 6 (if the "enterprise" property is true))
1201: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-blank-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7.1 (by default) or EAP 6 (if the "enterprise" property is true))
1202: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-ear-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7.1 (by default) or EAP 6 (if the "enterprise" property is true). The project is an EAR, with an EJB-JAR and WAR)
1203: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-ear-archetype-blank (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7 (by default) or EAP 6 (if the "enterprise" property is true). The project is an EAR, with an EJB-JAR and WAR)
1204: remote -> org.jboss.spec.archetypes:jboss-javaee6-webapp-ear-blank-archetype (An archetype that generates a starter Java EE 6 webapp project for JBoss AS 7.1 (by default) or EAP 6 (if the "enterprise" property is true). The project is an EAR, with an EJB-JAR and WAR)
1205: remote -> org.jboss.spring.archetypes:jboss-spring-mvc-archetype (An archetype that generates a starter Spring MVC application with Java EE persistence settings (server bootstrapped JPA, JTA transaction management) for JBoss AS7)
1206: remote -> org.jboss.spring.archetypes:spring-mvc-webapp (An archetype that generates a starter Spring MVC application with Java EE persistence settings (server bootstrapped JPA, JTA transaction management) for JBoss AS7)
1207: remote -> org.jboss.weld.archetypes:jboss-javaee6-webapp (An archetype that generates a starter Java EE 6 webapp project)
1208: remote -> org.jboss.weld.archetypes:jboss-jsf-weld-servlet-webapp (An archetype that generates a starter JSF webapp project with CDI capabilities for Servlet containers)
1209: remote -> org.jboss.weld.archetypes:weld-jsf-jee (Weld archetype for creating a Java EE 6 application using JSF 2.0, CDI 1.0, EJB 3.1 and JPA 2.0 (persistence unit included))
1210: remote -> org.jboss.weld.archetypes:weld-jsf-jee-minimal (Weld archetype for creating a minimal Java EE 6 application using JSF 2.0, CDI 1.0 and EJB 3.1 (persistence unit not included))
1211: remote -> org.jboss.weld.archetypes:weld-jsf-servlet-minimal (Weld archetype for creating an application using JSF 2.0 and CDI 1.0 for Servlet Containers (Tomcat 6 / Jetty 6))
1212: remote -> org.jboss.ws.plugins.archetypes:jaxws-codefirst (Creates a project for developing a Web Service starting from Java code and using JBossWS)
1213: remote -> org.jbpm:jbpm-console-ng-module-archetype (jBPM Console NG Module Archetype)
1214: remote -> org.jbundle.app.tools:jbundle-project-archetype (jbundle project archetype)
1215: remote -> org.jbundle.config:org.jbundle.config.archetype (-)
1216: remote -> org.jbundle.util.webapp:jbundle-util-webapp-cgi-archetype (-)
1217: remote -> org.jbundle.util.webapp:jbundle-util-webapp-files-archetype (-)
1218: remote -> org.jbundle.util.webapp:jbundle-util-webapp-proxy-archetype (-)
1219: remote -> org.jbundle.util.webapp:jbundle-util-webapp-redirect-archetype (-)
1220: remote -> org.jbundle.util.webapp:jbundle-util-webapp-upload-archetype (-)
1221: remote -> org.jbundle.util.webapp:jbundle-util-webapp-webdav-archetype (-)
1222: remote -> org.jbundle.util.webapp:jbundle-util-webapp-website-archetype (-)
1223: remote -> org.jbundle.util.webapp:jbundle-util-webapp-webstart-archetype (-)
1224: remote -> org.jbundle.util.webapp:jbundle-util-webapp-webstart-reactor-archetype (-)
1225: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.cgi-archetype (-)
1226: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.files-archetype (-)
1227: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.proxy-archetype (-)
1228: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.redirect-archetype (-)
1229: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.upload-archetype (-)
1230: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.webdav-archetype (-)
1231: remote -> org.jbundle.util.webapp:org.jbundle.util.webapp.website-archetype (-)
1232: remote -> org.jclouds:jclouds-compute-service-archetype (Maven archetype for a provider of a Compute service)
1233: remote -> org.jclouds:jclouds-rest-client-archetype (Maven archetype for a provider of a rest-speaking service)
1234: remote -> org.jibx.ota.osgi:jibx-ota-osgi-archetype (-)
1235: remote -> org.jibx.schema.config:opentravel-ws-archetype (-)
1236: remote -> org.jibx.schema.org.opentravel._2010B:opentravel-archetype (-)
1237: remote -> org.jibx.schema.org.opentravel._2011A:opentravel-archetype (-)
1238: remote -> org.jibx.schema.org.opentravel._2011B:opentravel-archetype (-)
1239: remote -> org.jibx.schema.org.opentravel._2011B.ws:opentravel-touractivity-ws-archetype (-)
1240: remote -> org.jibx.schema.org.opentravel._2011B.ws:opentravel-touractivity-ws-service-archetype (-)
1241: remote -> org.jibx.schema.org.opentravel._2012A:opentravel-archetype (-)
1242: remote -> org.jibx.schema.org.opentravel._2012A.ws:opentravel-touractivity-ws-service-archetype (-)
1243: remote -> org.jibx.schema.org.opentravel._2012B:opentravel-archetype (-)
1244: remote -> org.jibx.schema.org.opentravel._2012B.ws:opentravel-touractivity-ws-service-archetype (-)
1245: remote -> org.jibx.schema.org.opentravel._2013A:opentravel-archetype (-)
1246: remote -> org.jibx.schema.org.opentravel._2013A.ws:opentravel-touractivity-ws-service-archetype (-)
1247: remote -> org.jibx.schema.org.opentravel._2013B:opentravel-archetype (-)
1248: remote -> org.jibx.schema.org.opentravel._2013B.ws:opentravel-touractivity-ws-service-archetype (-)
1249: remote -> org.jibx.schema.org.opentravel._2014A:opentravel-archetype (-)
1250: remote -> org.jibx.schema.org.opentravel._2014A.ws:opentravel-touractivity-ws-service-archetype (-)
1251: remote -> org.jibx.schema.org.opentravel._2014B:opentravel-archetype (-)
1252: remote -> org.jibx.schema.org.opentravel._2014B.ws:opentravel-touractivity-ws-service-archetype (-)
1253: remote -> org.jini.maven-jini-plugin:jini-service-archetype (Archetype for Jini service project creation)
1254: remote -> org.jnario:jnario-archetype (Maven archetype for setting up a jnario project.)
1255: remote -> org.jooby:jooby-archetype (Maven archetype generator for Jooby)
1256: remote -> org.jorm-unit:jorm-unit-sample-archetype (Archetype that creates a sample project with jorm-unit sample test)
1257: remote -> org.jrebirth.af:archetype (JRebirth Archetype used to build a new fresh application)
1258: remote -> org.juzu:juzu-archetype (-)
1259: remote -> org.jvnet.hudson.tools:maven-hpi-plugin (Support for developing Hudson plugins with Apache Maven.)
1260: remote -> org.keedio.storm.topology.maven:storm-topology-archetype (Maven archetype to quickly generate storm topology projects.)
1261: remote -> org.kie:kie-drools-archetype (A basic kjar template with Drools rule example, JUnit 4 and logging binding.
...
1262: remote -> org.kuali.rice:rice-archetype-quickstart (This is a archetype which creates a Kuali Rice based application. It uses a basic project structure demonstrating war overlays, service implementation, unit and integration testing.  It is configured in a bundled integration model with Kuali Rice.)
1263: remote -> org.kualigan.kuali.contrib:kc-contrib-archetype (An archetype used to create projects intended to become customizations added to kuali projects via Maven dependencies)
1264: remote -> org.kualigan.kuali.contrib:kfs-contrib-archetype (An archetype used to create projects intended to become customizations added to kuali projects via Maven dependencies)
1265: remote -> org.kualigan.maven.archetypes:kc-archetype (-)
1266: remote -> org.kualigan.maven.archetypes:kfs-archetype (-)
1267: remote -> org.kualigan.maven.archetypes:kfs3-archetype (-)
1268: remote -> org.kualigan.maven.archetypes:kfs4-archetype (-)
1269: remote -> org.kualigan.maven.archetypes:kr-archetype (-)
1270: remote -> org.kualigan.maven.archetypes:lb-copy-archetype (Archetype used when copying databases. Creates a database project for the lb-maven-project to use in copying/exporting a database)
1271: remote -> org.makumba:makumba-archetype (Archetype for a makumba web-application)
1272: remote -> org.meruvian.midas:midas-archetype-blank (Generates blank Midas project template)
1273: remote -> org.meruvian.yama:yama-archetype (-)
1274: remote -> org.meruvian.yama:yama-jaxrs-archetype (-)
1275: remote -> org.meruvian.yama:yama-starter-archetype (-)
1276: remote -> org.meruvian.yama:yama-struts-archetype (-)
1277: remote -> org.mixer2:mixer2-springmvc-archetype (archetype for SpringMVC web application with mixer2)
1278: remote -> org.mobicents.servlet.sip.archetypes:maven-archetype-sipapp (Archetype providing a default layout to start building SIP Servlets Applications.)
1279: remote -> org.mobicents.servlet.sip.archetypes:mss-testing-embeddedTomcat6-archetype (-)
1280: remote -> org.mobicents.servlet.sip.archetypes:mss-testing-embeddedTomcat7-archetype (-)
1281: remote -> org.mortbay.jetty.archetype:jetty-archetype-assembler (-)
1282: remote -> org.mortbay.jetty.archetype:jetty-archetype-fileserver (-)
1283: remote -> org.mule.ibeans:ibean-archetype (An archetype for creating an empty ibean maven project)
1284: remote -> org.mule.tools:ibean-archetype (Creates a new iBean project that talks to an external service i.e. Twitter, Amazon S3, Flickr). The project will define the dependencies and documented sample
        code for the ibean itself and a a working testcase.)
1285: remote -> org.mule.tools:mule-catalog-archetype (-)
1286: remote -> org.mule.tools:mule-cloud-connector-archetype (Creates a new cloud connector project.)
1287: remote -> org.mule.tools:mule-example-archetype (An archetype for creating a Mule example application.)
1288: remote -> org.mule.tools:mule-module-archetype (An architype for creating a Mule Module. It provides options for adding certain mule features and configuring the
    module for Muleforge.)
1289: remote -> org.mule.tools:mule-project-archetype (An architype for creating Mule applications.)
1290: remote -> org.mule.tools:mule-transport-archetype (Archetype for Mule 2.0 and above transport projects.)
1291: remote -> org.mule.tools.maven:maven-achetype-mule-app (A simple maven tool to create mule applications)
1292: remote -> org.mule.tools.maven:maven-achetype-mule-domain (-)
1293: remote -> org.mule.tools.maven:maven-achetype-mule-domain-bundle (-)
1294: remote -> org.mule.tools.maven:maven-archetype-mule-app (A simple maven tool to create mule applications)
1295: remote -> org.mule.tools.maven:maven-archetype-mule-domain (-)
1296: remote -> org.multiverse:multiverse-project-archetype (Skeleton for a project using Multiverse)
1297: remote -> org.nakedobjects:application-archetype (-)
1298: remote -> org.nakedobjects:remoting-support (-)
1299: remote -> org.nakedobjects.archetypes:application (-)
1300: remote -> org.nakedobjects.plugins:hibernate-support (-)
1301: remote -> org.nakedobjects.plugins:html-war (-)
1302: remote -> org.nakedobjects.plugins:htmlviewer-war (-)
1303: remote -> org.nakedobjects.prototyping:application (-)
1304: remote -> org.nakedobjects.prototyping:icons (-)
1305: remote -> org.nakedosgi:bundle-archetype (-)
1306: remote -> org.ninjaframework:ninja-appengine-blog-archetype (Sonatype helps open source projects to set up Maven repositories on https://oss.sonatype.org/)
1307: remote -> org.ninjaframework:ninja-core-demo-archetype (-)
1308: remote -> org.ninjaframework:ninja-jpa-demo-archetype (-)
1309: remote -> org.ninjaframework:ninja-servlet-archetype-simple (-)
1310: remote -> org.ninjaframework:ninja-servlet-jpa-blog-archetype (-)
1311: remote -> org.ninjaframework:ninja-servlet-jpa-blog-integration-test-archetype (-)
1312: remote -> org.objectweb.fractal.cecilia:maven-archetype-cecilia-app (This archetype is useful to quick start Cecilia applications,
		having a source tree template already filled.)
1313: remote -> org.objectweb.fractal.cecilia:maven-archetype-cecilia-application (This archetype is useful to quick start Cecilia applications, having a
		source tree template already filled.)
1314: remote -> org.objectweb.fractal.cecilia:maven-archetype-cecilia-library (This archetype is useful to quick start Cecilia components library
		projects, having a source tree template already filled.)
1315: remote -> org.objectweb.petals:maven-archetype-petals-jbi-binding-component (>This project is Maven 2 archetype associated to a JBI binding component project.)
1316: remote -> org.objectweb.petals:maven-archetype-petals-jbi-service-assembly (This project is Maven 2 archetype associated to a JBI service assembly project.)
1317: remote -> org.objectweb.petals:maven-archetype-petals-jbi-service-engine (This project is Maven 2 archetype associated to a JBI service engine project.)
1318: remote -> org.objectweb.petals:maven-archetype-petals-jbi-service-unit (This project is Maven 2 archetype associated to a JBI service unit project.)
1319: remote -> org.ojbc.archetypes:ojb-connector-archetype (-)
1320: remote -> org.onosproject:onos-api-archetype (ONOS OSGi API bundle archetype)
1321: remote -> org.onosproject:onos-bundle-archetype (ONOS OSGi bundle archetype)
1322: remote -> org.onosproject:onos-cli-archetype (ONOS Apache Karaf bundle archetype)
1323: remote -> org.onosproject:onos-rest-archetype (ONOS REST API bundle archetype)
1324: remote -> org.onosproject:onos-ui-archetype (ONOS UI Custom-View overlay archetype)
1325: remote -> org.onosproject:onos-uitab-archetype (ONOS UI Table-View overlay archetype)
1326: remote -> org.onosproject:onos-uitopo-archetype (ONOS UI Topology-Overlay overlay archetype)
1327: remote -> org.opencoweb:admin-archetype (-)
1328: remote -> org.opencoweb:coweb-archetype (-)
1329: remote -> org.openehealth.ipf.archetypes:ipf-archetype-basic (-)
1330: remote -> org.openengsb.tooling.archetypes:openengsb-tooling-archetypes-connector (Archetype to produce new Connector project)
1331: remote -> org.openengsb.tooling.archetypes:openengsb-tooling-archetypes-domain (Archetype to produce new Domain project)
1332: remote -> org.openengsb.tooling.archetypes:org.openengsb.tooling.archetypes.connector (Archetype to produce new Connector project)
1333: remote -> org.openengsb.tooling.archetypes:org.openengsb.tooling.archetypes.domain (Archetype to produce new Domain project)
1334: remote -> org.openengsb.tooling.archetypes.clientproject:org.openengsb.tooling.archetypes.clientproject.root (Archetype to produce new client project)
1335: remote -> org.opengis.cite:ets-archetype-testng (A template for creating an executable test suite (ETS) based on the TestNG framework.)
1336: remote -> org.openimaj:openimaj-quickstart-archetype (Maven quickstart archetype for OpenIMAJ)
1337: remote -> org.openimaj:openimaj-subproject-archetype (Maven archetype for creating OpenIMAJ subprojects with the most of the standard configuration completed automatically)
1338: remote -> org.openjdk.jmh:jmh-groovy-benchmark-archetype (Generates Groovy benchmarking project, uses JMH bytecode processors)
1339: remote -> org.openjdk.jmh:jmh-java-benchmark-archetype (Generates Java benchmarking project, uses JMH annotation processors)
1340: remote -> org.openjdk.jmh:jmh-kotlin-benchmark-archetype (Generates Kotlin benchmarking project, uses JMH bytecode processors)
1341: remote -> org.openjdk.jmh:jmh-scala-benchmark-archetype (Generates Scala benchmarking project, uses JMH bytecode processors)
1342: remote -> org.openjdk.jmh:jmh-simple-benchmark-archetype (Basic archetype for simple JMH-driven benchmark.)
1343: remote -> org.openl.rules:openl-simple-project (-)
1344: remote -> org.openl.rules:openl-simple-project-archetype (-)
1345: remote -> org.openntf.maven:odp-maven-archetype (-)
1346: remote -> org.opoo.press.maven.archetypes:opoopress-archetype-site (Archetype for creating a basic OpooPress site with sample plugin.)
1347: remote -> org.opoo.press.maven.archetypes:opoopress-archetype-site-blank (Archetype for creating a blank OpooPress site.)
1348: remote -> org.opoo.press.maven.archetypes:opoopress-archetype-theme (Archetype for creating a blank OpooPress theme project.
                artifactId must be start with prefix: 'opoopress-theme-'.')
1349: remote -> org.ops4j.pax.construct:maven-archetype-osgi-bundle (-)
1350: remote -> org.ops4j.pax.construct:maven-archetype-osgi-project (-)
1351: remote -> org.ops4j.pax.construct:maven-archetype-osgi-service (-)
1352: remote -> org.ops4j.pax.construct:maven-archetype-osgi-wrapper (-)
1353: remote -> org.ops4j.pax.construct:maven-archetype-spring-bean (-)
1354: remote -> org.ops4j.pax.exam:maven-archetype-paxexam-junit ()
1355: remote -> org.ops4j.pax.exam.archetypes:exam-glassfish41-archetype (Archetype for Pax Exam tests on GlassFish 4.1)
1356: remote -> org.ops4j.pax.exam.archetypes:exam-karaf-archetype (Archetype for Pax Exam tests on Karaf)
1357: remote -> org.ops4j.pax.exam.archetypes:exam-osgi-archetype (Archetype for Pax Exam tests on OSGi frameworks)
1358: remote -> org.ops4j.pax.exam.archetypes:exam-wildfly80-archetype (Archetype for Pax Exam tests on WildFly 8.0)
1359: remote -> org.ops4j.pax.web.archetypes:wab-archetype (-)
1360: remote -> org.ops4j.pax.web.archetypes:wab-gwt-archetype (-)
1361: remote -> org.ops4j.pax.web.archetypes:war-archetype (-)
1362: remote -> org.orienteer:orienteer-archetype-war (-)
1363: remote -> org.ow2.jasmine.kerneos:kerneos-module-archetype (-)
1364: remote -> org.ow2.jasmine.kerneos:kerneos-war-archetype (-)
1365: remote -> org.ow2.jasmine.probe:jprobe-collector-archetype (-)
1366: remote -> org.ow2.jasmine.probe:jprobe-outer-archetype (-)
1367: remote -> org.ow2.jonas.camel:camel-archetype-simple-route (-)
1368: remote -> org.ow2.kerneos:kerneos-application-archetype (-)
1369: remote -> org.ow2.kerneos:kerneos-flex-archetypes-application (-)
1370: remote -> org.ow2.kerneos:kerneos-flex-archetypes-module (-)
1371: remote -> org.ow2.kerneos:kerneos-flex-archetypes-module-fragment (-)
1372: remote -> org.ow2.kerneos:kerneos-module-archetype (-)
1373: remote -> org.ow2.orchestra:orchestra-extension-archetype (Generates extensions for Orchestra)
1374: remote -> org.ow2.petals:maven-archetype-petals-jbi-binding-component (This project is Maven 2 archetype associated to a JBI binding component project.)
1375: remote -> org.ow2.petals:maven-archetype-petals-jbi-service-assembly (This project is Maven 2 archetype associated to a JBI service assembly project.)
1376: remote -> org.ow2.petals:maven-archetype-petals-jbi-service-engine (This project is Maven 2 archetype associated to a JBI service engine project.)
1377: remote -> org.ow2.petals:maven-archetype-petals-jbi-service-unit (This project is Maven 2 archetype associated to a JBI service unit project.)
1378: remote -> org.ow2.petals:maven-archetype-petals-jbi-shared-library (This project is Maven 2 archetype associated to a JBI Shared Library project.)
1379: remote -> org.ow2.shelbie:shelbie-command-archetype (-)
1380: remote -> org.ow2.weblab.tools.maven:weblab-archetype-analyser (The Archetype used to generate a stub for analyser. This should be called through the weblab-archetype-plugin and not directly.)
1381: remote -> org.ow2.weblab.tools.maven:weblab-archetype-configurable (The Archetype used to generate a stub for configurable. This should be called through the weblab-archetype-plugin and not directly.)
1382: remote -> org.ow2.weblab.tools.maven:weblab-archetype-indexer (The Archetype used to generate a stub for indexer. This should be called through the weblab-archetype-plugin and not directly.)
1383: remote -> org.ow2.weblab.tools.maven:weblab-archetype-queuemanager (The Archetype used to generate a stub for queuemanager. This should be called through the weblab-archetype-plugin and not directly.)
1384: remote -> org.ow2.weblab.tools.maven:weblab-archetype-reportprovider (The Archetype used to generate a stub for reportprovider. This should be called through the weblab-archetype-plugin and not directly.)
1385: remote -> org.ow2.weblab.tools.maven:weblab-archetype-resourcecontainer (The Archetype used to generate a stub for resourcecontainer. This should be called through the weblab-archetype-plugin and not directly.)
1386: remote -> org.ow2.weblab.tools.maven:weblab-archetype-resources (The Archetype used to generate a stub for any WebLab service. It should be used in conjunction with interfaces specific archetypes. This should be called through the weblab-archetype-plugin and not directly.)
1387: remote -> org.ow2.weblab.tools.maven:weblab-archetype-searcher (The Archetype used to generate a stub for searcher. This should be called through the weblab-archetype-plugin and not directly.)
1388: remote -> org.ow2.weblab.tools.maven:weblab-archetype-sourcereader (The Archetype used to generate a stub for sourcereader. This should be called through the weblab-archetype-plugin and not directly.)
1389: remote -> org.ow2.weblab.tools.maven:weblab-archetype-trainable (The Archetype used to generate a stub for trainable. This should be called through the weblab-archetype-plugin and not directly.)
1390: remote -> org.parallelj:parallelj-archetype (ParallelJ is a Java framework for parallel computing. It provides flow modeling and execution. This archetype projects allows to create a project skeleton using ParallelJ.)
1391: remote -> org.parallelj:parallelj-archetype-web (ParallelJ is a Java framework for parallel computing. It provides flow modeling and execution. This archetype projects allows to create a project skeleton using ParallelJ.)
1392: remote -> org.parancoe:parancoe-pluginarchetype (-)
1393: remote -> org.parancoe:parancoe-webarchetype (-)
1394: remote -> org.patterntesting:patterntesting-tools (PatternTesting Tools (patterntesting-tools) is the container for
    tools around PatternTesting like the Ant extensions and Maven plugin.)
1395: remote -> org.peelframework:peel-flink-bundle (-)
1396: remote -> org.peelframework:peel-flinkspark-bundle (-)
1397: remote -> org.peelframework:peel-spark-bundle (-)
1398: remote -> org.pustefixframework:pustefix-archetype-application (Pustefix Archetype for Applications)
1399: remote -> org.pustefixframework:pustefix-archetype-basic (Pustefix archetype creating a basic application)
1400: remote -> org.pustefixframework.maven.archetypes:pustefix-archetype-module (Pustefix Archetype for Modules)
1401: remote -> org.qianalyze:QiAnalyzeModule-Archetype (The archetype to create a new QiAnalyze Module for more information visit http://java.net/projects/qianalyze)
1402: remote -> org.qianalyze.sample:QiAnalyzeModule (The archetype to create a new QiAnalyze Module for more information visit http://java.net/projects/qianalyze)
1403: remote -> org.qooxdoo:qooxdoo-archetype-desktop (An archetype to create a qooxdoo application)
1404: remote -> org.qooxdoo:qooxdoo-archetype-gui (An archetype to create a qooxdoo application)
1405: remote -> org.quattor.maven:cfg-module (-)
1406: remote -> org.quattor.pan:panc-maven-archetype (-)
1407: remote -> org.rauschig:maven-archetype-bundle (A maven archetype that incorporates common artifacts for OSS development and OSGi compatibility)
1408: remote -> org.resthub:resthub-jpa-backbonejs-archetype (-)
1409: remote -> org.resthub:resthub-jpa-backbonejs-multi-archetype (-)
1410: remote -> org.resthub:resthub-mongodb-backbonejs-archetype (-)
1411: remote -> org.resthub:resthub-mongodb-backbonejs-multi-archetype (-)
1412: remote -> org.rhq:rhq-plugin-archetype (-)
1413: remote -> org.rhq.maven:smartgwt-war-archetype (archetype for a Maven project for a SmartGWT web application (WAR))
1414: remote -> org.richfaces.archetypes:richfaces-archetype-kitchensink (A starter Java EE 6 webapp project for use on JBoss AS 7 / EAP 6, generated from the
        jboss-javaee6-webapp archetype)
1415: remote -> org.richfaces.archetypes:richfaces-archetype-simpleapp (-)
1416: remote -> org.robovm:robovm-console-template (-)
1417: remote -> org.robovm:robovm-cross-platform-kotlin-template (-)
1418: remote -> org.robovm:robovm-cross-platform-template (-)
1419: remote -> org.robovm:robovm-default-template (-)
1420: remote -> org.robovm:robovm-single-view-template (-)
1421: remote -> org.robovm:robovm-templates-console (-)
1422: remote -> org.robovm:robovm-templates-cross-platform (-)
1423: remote -> org.robovm:robovm-templates-cross-platform-kotlin (-)
1424: remote -> org.robovm:robovm-templates-ios-single-view (-)
1425: remote -> org.robovm:robovm-templates-ios-single-view-no-ib (-)
1426: remote -> org.robovm:robovm-templates-tvos-single-view (-)
1427: remote -> org.robovm:robovm-templates-tvos-single-view-no-ib (-)
1428: remote -> org.sadiframework:sadi-service-archetype (-)
1429: remote -> org.sakaiproject.maven-archetype:sakai-wicket-maven-archetype (The Sakai Wicket Maven Archetype allows you to generate a sample Sakai app via a single Maven command. 
...
1430: remote -> org.scala-tools.archetypes:liftweb-archetype-blank (Archetype - blank project for liwftweb)
1431: remote -> org.scala-tools.archetypes:liftweb-archetype-hellolift (Archetype - hellolift sample liwftweb application)
1432: remote -> org.scala-tools.archetypes:scala-archetype-simple (The maven-scala-plugin is used for compiling/testing/running/documenting scala code in maven.)
1433: remote -> org.scalatra.scalate.tooling:scalate-archetype-guice_2.10 (An archetype which creates an empty Scalate Guice web application)
1434: remote -> org.scalatra.scalate.tooling:scalate-archetype-guice_2.11 (An archetype which creates an empty Scalate Guice web application)
1435: remote -> org.scalatra.scalate.tooling:scalate-archetype-jersey_2.10 (An archetype which creates an empty Scalate web application)
1436: remote -> org.scalatra.scalate.tooling:scalate-archetype-jersey_2.11 (An archetype which creates an empty Scalate web application)
1437: remote -> org.scalatra.scalate.tooling:scalate-archetype-sitegen_2.10 (An archetype which creates an empty Scalate static website generation project)
1438: remote -> org.scalatra.scalate.tooling:scalate-archetype-sitegen_2.11 (An archetype which creates an empty Scalate static website generation project)
1439: remote -> org.sculptorgenerator:sculptor-maven-archetype (Maven archetype for a business tier project using the Sculptor code generator)
1440: remote -> org.sculptorgenerator:sculptor-maven-archetype-ear (Maven archetype for a EAR project using the Sculptor code generator)
1441: remote -> org.sculptorgenerator:sculptor-maven-archetype-parent (Maven archetype for a parent project using the Sculptor code generator)
1442: remote -> org.sculptorgenerator:sculptor-maven-archetype-web (Maven archetype for a WAR project using the Sculptor code generator)
1443: remote -> org.seedstack:batch-archetype (SeedStack mono-module JAR integrating Spring Batch)
1444: remote -> org.seedstack:cli-archetype (SeedStack single JAR for CLI applications)
1445: remote -> org.seedstack:domain-archetype (SeedStack mono-module JAR for reusable domains)
1446: remote -> org.seedstack:rest-archetype (SeedStack mono-module WAR dedicated to REST-only projects, like micro-services)
1447: remote -> org.seedstack:web-archetype (SeedStack multi-module WAR project for classic Web applications)
1448: remote -> org.siqisource.agave:archetypes-quickstart (-)
1449: remote -> org.sitoolkit.ad.archetype:javaee7-web-min (archetype for javaee7 minimum web application,
     useful for self study and developing new application.)
1450: remote -> org.sitoolkit.ad.archetype:javaee7-web-tips (archetype for javaee7 web application with useful tips)
1451: remote -> org.sitoolkit.ad.archetype:sit-ad-archetype (This project is generated from org.sitoolkit.archetype:sit-ad-archetype)
1452: remote -> org.sitoolkit.archetype:sit-archetype (This project is generated from org.sitoolkit.archetype:sit-archetype)
1453: remote -> org.sitoolkit.tester:sit-tester-archetype (archetype for sit-tester)
1454: remote -> org.sitoolkit.wt:sit-wt-archetype (archetype for sit-wt)
1455: remote -> org.sitoolkit.wt:sit-wt-project (archetype for sit-wt)
1456: remote -> org.slf4j:slf4j-archetype (The slf4j Archetype)
1457: remote -> org.slick2d:slick2d-basic-game-archetype (Maven archetype for a Slick2D based game)
1458: remote -> org.sonatype.flexmojos:flexmojos-archetypes-application (-)
1459: remote -> org.sonatype.flexmojos:flexmojos-archetypes-library (-)
1460: remote -> org.sonatype.flexmojos:flexmojos-archetypes-modular-webapp (-)
1461: remote -> org.sonatype.nexus.archetypes:nexus-plugin-archetype (-)
1462: remote -> org.springframework.boot:spring-boot-sample-actuator-archetype (Spring Boot Actuator Sample)
1463: remote -> org.springframework.boot:spring-boot-sample-actuator-log4j-archetype (Spring Boot Actuator Log4J Sample)
1464: remote -> org.springframework.boot:spring-boot-sample-actuator-noweb-archetype (Spring Boot Actuator Non-Web Sample)
1465: remote -> org.springframework.boot:spring-boot-sample-actuator-ui-archetype (Spring Boot Actuator UI Sample)
1466: remote -> org.springframework.boot:spring-boot-sample-amqp-archetype (Spring Boot AMQP Sample)
1467: remote -> org.springframework.boot:spring-boot-sample-aop-archetype (Spring Boot AOP Sample)
1468: remote -> org.springframework.boot:spring-boot-sample-batch-archetype (Spring Boot Batch Sample)
1469: remote -> org.springframework.boot:spring-boot-sample-data-jpa-archetype (Spring Boot Data JPA Sample)
1470: remote -> org.springframework.boot:spring-boot-sample-data-mongodb-archetype (Spring Boot Data MongoDB Sample)
1471: remote -> org.springframework.boot:spring-boot-sample-data-redis-archetype (Spring Boot Data Redis Sample)
1472: remote -> org.springframework.boot:spring-boot-sample-data-rest-archetype (Spring Boot Data REST Sample)
1473: remote -> org.springframework.boot:spring-boot-sample-integration-archetype (Spring Boot Integration Sample)
1474: remote -> org.springframework.boot:spring-boot-sample-jetty-archetype (Spring Boot Jetty Sample)
1475: remote -> org.springframework.boot:spring-boot-sample-profile-archetype (Spring Boot Profile Sample)
1476: remote -> org.springframework.boot:spring-boot-sample-secure-archetype (Spring Boot Security Sample)
1477: remote -> org.springframework.boot:spring-boot-sample-servlet-archetype (Spring Boot Servlet Sample)
1478: remote -> org.springframework.boot:spring-boot-sample-simple-archetype (Spring Boot Simple Sample)
1479: remote -> org.springframework.boot:spring-boot-sample-tomcat-archetype (Spring Boot Tomcat Sample)
1480: remote -> org.springframework.boot:spring-boot-sample-traditional-archetype (Spring Boot Traditional Sample)
1481: remote -> org.springframework.boot:spring-boot-sample-web-jsp-archetype (Spring Boot Web JSP Sample)
1482: remote -> org.springframework.boot:spring-boot-sample-web-method-security-archetype (Spring Boot Web Method Security Sample)
1483: remote -> org.springframework.boot:spring-boot-sample-web-secure-archetype (Spring Boot Web Secure Sample)
1484: remote -> org.springframework.boot:spring-boot-sample-web-static-archetype (Spring Boot Web Static Sample)
1485: remote -> org.springframework.boot:spring-boot-sample-web-ui-archetype (Spring Boot Web UI Sample)
1486: remote -> org.springframework.boot:spring-boot-sample-websocket-archetype (Spring Boot WebSocket Sample)
1487: remote -> org.springframework.boot:spring-boot-sample-xml-archetype (Spring Boot XML Sample)
1488: remote -> org.springframework.osgi:spring-osgi-bundle-archetype (Spring OSGi Maven2 Archetype)
1489: remote -> org.springframework.ws:spring-ws-archetype (Spring Web Services Maven2 Archetype.)
1490: remote -> org.sqlproc:sqlproc-archetype-simple-jdbc (SQL Processor Archetype for Simple JDBC Application)
1491: remote -> org.sqlproc:sqlproc-archetype-simple-spring (SQL Processor Archetype for Simple Spring Application)
1492: remote -> org.stackbox.archetypes:hadoop-v1-mr (A set of maven3 archetypes during my career in Miaozhen Systems)
1493: remote -> org.stackbox.archetypes:webapp-ssm-basic (A set of maven3 archetypes during my career in Miaozhen Systems)
1494: remote -> org.structr:structr-base-archetype (Structr is an open source framework based on the popular Neo4j graph database.)
1495: remote -> org.structr:structr-simple-example-archetype (Structr is an open source framework based on the popular Neo4j graph database.)
1496: remote -> org.structr:structr-ui-archetype (Structr is an open source framework based on the popular Neo4j graph database.)
1497: remote -> org.sweble.wikitext:swc-example-basic-archetype (An archetype that creates a simple application which is able to parse a page
    written in Wikitext and render it as HTML.)
1498: remote -> org.sweble.wikitext:swc-example-serialization-archetype (An example project that contains a simple application that is able to parse
    a page written in Wikitext and serialize it to XML, JSON or binary.)
1499: remote -> org.sweble.wikitext:swc-example-xpath-archetype (An archetype that creates a simple application which is able to parse
    a page written in Wikitext and perform an XPath query on that document.)
1500: remote -> org.switchyard.archetypes:switchyard-application (-)
1501: remote -> org.syncope:syncope-archetype (Syncope archetype)
1502: remote -> org.teavm:teavm-maven-webapp (An archetype that creates a simple web application with enabled TeaVM)
1503: remote -> org.telosys.starterkits:angularHtml5offline-starterkit (archetype for starter Kit angular Html5 offline)
1504: remote -> org.telosys.starterkits:struts-jpa-starterkit (archetype for starter Kit Struts)
1505: remote -> org.tinygroup:buproject (-)
1506: remote -> org.tinygroup:flowcomponent (-)
1507: remote -> org.tinygroup:org.tinygroup.developarchetype (-)
1508: remote -> org.tinygroup:org.tinygroup.flowcomponentarchetype (-)
1509: remote -> org.tinygroup:org.tinygroup.plugincomponentarchetype (-)
1510: remote -> org.tinygroup:org.tinygroup.uicomponentarchetype (-)
1511: remote -> org.tinygroup:plugincomponent (-)
1512: remote -> org.tinygroup:servicecomponentarchetype (-)
1513: remote -> org.tinygroup:uicomponent-archetype (-)
1514: remote -> org.tinygroup:webappproject (-)
1515: remote -> org.tinygroup:webappprojectarchetype (-)
1516: remote -> org.tomitribe:tomitribe-crest-archetype (-)
1517: remote -> org.trailsframework:trails-archetype (-)
1518: remote -> org.trailsframework:trails-secure-archetype (-)
1519: remote -> org.tynamo:tynamo-archetype (-)
1520: remote -> org.uberfire:uberfire-component-archetype (UberFire Component Archetype)
1521: remote -> org.uberfire:uberfire-project-archetype (UberFire Project Archetype)
1522: remote -> org.umlg:umlg-archetype (Generates a Umlg application with Umlg's datatypes, validation profile and a rest interface)
1523: remote -> org.walkmod:walkmod-plugin-archetype (Archetype to create a walkmod plugin)
1524: remote -> org.wicketstuff.scala:wicket-scala-archetype (Basic setup for a project that combines Scala and Wicket, 
		depending on the Wicket-Scala project. Includes an example Specs 
		test.)
1525: remote -> org.wicketstuff.scala:wicketstuff-scala-archetype (Basic setup for a project that combines Scala and Wicket, 
		depending on the Wicket-Scala project. Includes an example Specs 
		test.)
1526: remote -> org.wikbook:wikbook.archetype (-)
1527: remote -> org.wildfly.archetype:wildfly-html5-mobile-archetype (An archetype that generates a Java EE 7 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1528: remote -> org.wildfly.archetype:wildfly-html5-mobile-blank-archetype (An archetype that generates a Java EE 7 application using HTML5, and JAX-RS to support both desktop and mobile web browsers)
1529: remote -> org.wildfly.archetype:wildfly-javaee7-webapp-archetype (An archetype that generates a starter Java EE 7 webapp project for JBoss Wildfly)
1530: remote -> org.wildfly.archetype:wildfly-javaee7-webapp-blank-archetype (An archetype that generates a starter Java EE 7 webapp project for JBoss Wildfly)
1531: remote -> org.wildfly.archetype:wildfly-javaee7-webapp-ear-archetype (An archetype that generates a starter Java EE 7 webapp project for JBoss Wildfly. The project is an EAR, with an EJB-JAR and WAR)
1532: remote -> org.wildfly.archetype:wildfly-javaee7-webapp-ear-blank-archetype (An archetype that generates a starter Java EE 7 webapp project for JBoss Wildfly. The project is an EAR, with an EJB-JAR and WAR)
1533: remote -> org.wildfly.archetypes:wildfly-subsystem (An archetype that generates a skeleton project for implementing a WildFly 8 subsystem)
1534: remote -> org.wildfly.camel.archetypes:wildfly-camel-archetype-cdi (Creates a WildFly Camel CDI application)
1535: remote -> org.wildfly.camel.archetypes:wildfly-camel-archetype-spring (Creates a WildFly Camel Spring application)
1536: remote -> org.wildfly.swarm:archetype (-)
1537: remote -> org.wiperdog:wiperdog-osgi-bundle-archetype (-)
1538: remote -> org.wiperdog:wiperdog-osgi-ipojo-archetype (-)
1539: remote -> org.wisdom-framework:wisdom-default-project-archetype (-)
1540: remote -> org.wisdom-framework:wisdom-simple-watcher-archetype (-)
1541: remote -> org.wso2.carbon:org.wso2.carbon.archetypes.bundle (This is an archetype for an OSGi bundle)
1542: remote -> org.wso2.carbon:org.wso2.carbon.archetypes.component (This is an archetype for a Carbon Component which consumes an OSGi service registered by Carbon Kernel)
1543: remote -> org.wso2.msf4j:msf4j-microservice (This an archetype for WSO2 MSF4J microservice)
1544: remote -> org.xaloon.archetype:xaloon-archetype-wicket-jpa-glassfish (-)
1545: remote -> org.xaloon.archetype:xaloon-archetype-wicket-jpa-spring (-)
1546: remote -> org.xillium:xillium-arch (-)
1547: remote -> org.xwiki.commons:xwiki-commons-component-archetype (Make it easy to create a maven project for creating XWiki Components.)
1548: remote -> org.xwiki.rendering:xwiki-rendering-archetype-macro (Make it easy to create a maven project for creating XWiki Rendering Macros.)
1549: remote -> org.zkoss:zk-archetype-component (An archetype that generates a starter ZK component project)
1550: remote -> org.zkoss:zk-archetype-datahandler (An archetype that generates a starter ZK datahandler project)
1551: remote -> org.zkoss:zk-archetype-extension (An archetype that generates a starter ZK extension project)
1552: remote -> org.zkoss:zk-archetype-theme (An archetype that generates a starter ZK theme project)
1553: remote -> org.zkoss:zk-archetype-webapp (An archetype that generates a starter ZK CE webapp project)
1554: remote -> org.zkoss:zk-ee-eval-archetype-webapp (An archetype that generates a starter ZK EE-eval webapp project)
1555: remote -> org.zkoss:zk-ee-eval-archetype-webapp-spring (An archetype that generates a starter ZK EE-eval webapp project with Spring)
1556: remote -> org.zkoss:zk-ee-eval-archetype-webapp-spring-jpa (An archetype that generates a starter ZK EE-eval webapp project with Spring and JPA)
1557: remote -> pl.bristleback:webapp-archetype (Web archetype for Bristleback Websocket Framework)
1558: remote -> pl.najda:dw-archetype (Archetype for building an initial structure of directories and files for Dropwizard web services. Contains a simple web service (available at http://localhost:8082/hello-world) with sources - to simplify development.)
1559: remote -> pl.org.miki:java8-quickstart-archetype (Basic Java 8 archetype. Options:
...
1560: remote -> pl.org.miki:scala-quickstart-archetype (Customizable cruft-free Scala archetype. Options:
...
1561: remote -> pro.savant.circumflex:webapp-archetype (-)
1562: remote -> ro.pippo:pippo-quickstart (-)
1563: remote -> ru.circumflex:circumflex-archetype (-)
1564: remote -> ru.nikitav.android.archetypes:release (-)
1565: remote -> ru.nikitav.android.archetypes:release-robolectric (-)
1566: remote -> ru.stqa.selenium:webdriver-java-archetype (Archetype for a Maven project intended to develop tests with Selenium WebDriver and JUnit/TestNG)
1567: remote -> ru.stqa.selenium:webdriver-junit-archetype (Archetype for a Maven project intended to develop tests with Selenium WebDriver and JUnit)
1568: remote -> ru.stqa.selenium:webdriver-testng-archetype (Archetype for a Maven project intended to develop tests with Selenium WebDriver and TestNG)
1569: remote -> ru.yandex.cocaine:cocaine-client-archetype (Archetype for creating a basic client for Cocaine Application Engine.)
1570: remote -> ru.yandex.cocaine:cocaine-worker-archetype (Archetype for creating a basic worker for Cocaine Application Engine.)
1571: remote -> ru.yandex.qatools.camelot:camelot-plugin (-)
1572: remote -> se.vgregion.javg.maven.archetypes:javg-minimal-archetype (-)
1573: remote -> se.walkercrou:ghp-maven-archetype (Quickstart for developers wanting to integrate the GHP Maven Plugin)
1574: remote -> sk.seges.sesam:sesam-annotation-archetype (-)
1575: remote -> tk.skuro:clojure-maven-archetype (A simple Maven archetype for Clojure)
1576: remote -> tr.com.lucidcode:kite-archetype (A Maven Archetype that allows users to create a Fresh Kite project)
1577: remote -> tr.com.obss.sdlc.archetype:obss-archetype-java (This archetype provides a common skelton for the Java packages.)
1578: remote -> tr.com.obss.sdlc.archetype:obss-archetype-webapp (This archetype provides a skelton for the Java Web Application packages.)
1579: remote -> uk.ac.ebi.gxa:atlas-archetype (Archetype for generating a custom Atlas webapp)
1580: remote -> uk.ac.rdg.resc:edal-ncwms-based-webapp (-)
1581: remote -> uk.co.nemstix:basic-javaee7-archetype (A basic Java EE7 Maven archetype)
1582: remote -> uk.co.solong:angular-spring-archetype (So Long archetype for RESTful spring services with an AngularJS frontend. Includes debian deployment)
1583: remote -> us.fatehi:schemacrawler-archetype-maven-project (-)
1584: remote -> us.fatehi:schemacrawler-archetype-plugin-command (-)
